...
Depending on your preference of heat and love for peanuts, the amount of cayenne pepper and peanuts can vary.
...
#Euclidean Distance:
###Definition:
The **Euclidean distance** between points **p** and **q** is the legth of the **line segment** connecting them $\overline{pq}$. In **Cartesian coordinates**, if **p** = $(p_1, p_2, ..., p_n)$ and **q** = $(q_1, q_2, ..., q_n)$ are two points in Eucliedean *n*-space, then the distance (d) from **p** to **q**, or from **q** to **p** is given by the **Pythagorean formula**.
